...
<!-- The individual and team project for this class are designed to mirror the experiences of a software engineer joining a new development team: you will be “onboarded” to our codebase, make several individual contributions, and then form a team to propose, develop and implement new features. The codebase that we’ll be developing on is a Fake Stack Overflow project (Called Degree Defender). You will get an opportunity to work with the starter code which provides basic skeleton for the app and then additional features will be proposed and implemented by you! All implementation will take place in the TypeScript programming language, using React for the user interface. -->

## Degree Defender
This website is a forum for software developers that want to connect with others to ask questions, collaborate, and otherwise reach out to one another. We prioritize security and community with our SSO features for authentication, community notes for accountability and legitimacy, and community pages to foster connections and cooperation.
