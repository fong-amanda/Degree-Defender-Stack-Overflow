 ...
 * - `acceptedNotes`: Whether or not the user is a moderator.
 * - `rejectedNotes`: Whether or not the user is a moderator.
 */
 ...
 * - `dateJoined`: The date when the user registered.
 * - `biography`: A short description or bio of the user (optional).
 * - `isModerator`: Whether or not the user is a moderator.
...
export interface UpdateModeratorRequest extends Request {
  body: {
    username: string;
    isModerator: boolean;
  };
...
export interface UpdateAcceptedNotesRequest extends Request {
  body: {
    username: string;
    acceptedNotes: number;
  };
...
export interface UpdateRejectedNotesRequest extends Request {
  body: {
    username: string;
    rejectedNotes: number;
  };
...
export interface UpdateBanStatusRequest extends Request {
  body: {
    username: string;
    isBanned: boolean;
  };
