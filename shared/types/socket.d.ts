...
import { SafeDatabaseUser } from './user.d';
import { BaseMove, GameInstance, GameInstanceID, GameMove, GameState } from './game';
import { PopulatedDatabaseGroupChat } from './groupChat';
import { DatabaseCommunityNote } from './community';
...
/**
 * Payload for a group chat update event.
 */
 ...
 * Payload for a group chat update event.
 */
export interface CommunityNoteUpdatePayload {
  note: DatabaseCommunityNote;
  type: 'status';
}
 ...
 * - `communityNoteUpdate`: Server sends updated note.
 */
export interface ServerToClientEvents {
  ...
  groupChatUpdate: (chat: GroupChatUpdatePayload) => void;
  communityNoteUpdate: (chat: CommunityNoteUpdatePayload) => void;
}
