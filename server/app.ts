...
import communityGroupController from './controllers/communitygroup.controller';
import communityNoteController from './controllers/communitynote.controller';
...
app.use('/community', communityGroupController(socket));
app.use('/api/community-notes', communityNoteController(socket));
